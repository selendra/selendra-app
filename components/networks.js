...
const network = () => {
  return (
    <div className="h-[82vh] flex place-content-center flex-col">
      <center>
        <h1
          className="md:text-7xl font-extrabold text-transparent text-4xl bg-clip-text bg-gradient-to-r from-blue-800 to-green-600 text-center"
              ...
              <div
                className={
                  res.name == "Testnet"
                    ...
                    : "p-0.5  pb-2 bg-gradient-to-r rounded-2xl from-blue-800 to-green-600 text-center"
                }
                    ...
                    <h2
                      className={
                        res.name == "Testnet"
                          ...
                          : "font-extrabold text-transparent text-4xl bg-clip-text bg-gradient-to-r from-blue-800 to-green-600 text-center"
                      }
                    >
                      {res.name}
                    </h2>
